...
python3.6 tools/generate_scene_descriptions_fewshot.py train fewshot $TABLETOP_TRAIN_START $TABLETOP_TRAIN_END \
    --suncg_dir $SUNCG_DIR \
...
#        python3.6 tools/generate_scene_descriptions_fewshot.py train fewshot $cpu_start $cpu_end \
#               --suncg_dir $SUNCG_DIR \
#               --shapenet_dir $SHAPENET_DIR --texture_dir $TEXTURE_DIR --coco_dir $COCO_DIR --save_path $SAVE_PATH \
