...
def parse_arguments():
    ...
    parser.add_argument('--google_dir', required=True, help="Google scan directory")
...
def get_simulation_params(args):
    ...
    simulation_params = {
        ...
        'ycb_obj_percentage' : 1.0,
        'shapenet_obj_percentage' : 0.0,
        'cuboid_percentage' : 0.0,
        'cylinder_percentage' : 0.0,
